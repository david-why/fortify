/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2ca55199d1a97d1e3d7b2fed5ae03e33)
// Runtime types generated with workerd@1.20251109.0 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NUXT_SLACK_VERIFICATION_TOKEN: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_SLACK_VERIFICATION_TOKEN">> {}
}
